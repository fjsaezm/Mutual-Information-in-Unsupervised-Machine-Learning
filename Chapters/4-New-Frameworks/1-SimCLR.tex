...
%------------- Footnotemark
\footnotetext{\emph{Fine-Tuning} reffers to the process of re-training certain parts of an already trained NN so that it focuses its learn on specific examples, such as a different dataset.}
%----------------------