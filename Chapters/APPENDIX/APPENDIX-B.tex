...
\begin{table}[H]
    ...
    The results obtained for the second experiment, which was presented in Section \ref{byol:second:experiment}, are presented in table \ref{table:byol:gridsearch:2}.
    \begin{table}[H]
        \resizebox{\columnwidth}{!}{
        \begin{tabular}{rrrrr}
        batch\_size  & regularization\_loss & label\_top\_1\_accuracy & label\_top\_5\_accuracy & global\_step    \\ \hline
