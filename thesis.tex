...
\input{Chapters/1-Probability-Theory/0-Intro}
\clearpage
\chapter{Probability theory}
\input{Chapters/1-Probability-Theory/1-Introduction}
\clearpage
\chapter{Distributions and Kullback-Leibler Divergence}
\input{Chapters/1-Probability-Theory/2-Distributions}
\clearpage
\chapter{Statistical Inference}
\input{Chapters/1-Probability-Theory/3-Inference}
\clearpage
\chapter{Noise Contrastive Estimation}
\input{Chapters/1-Probability-Theory/4-Noise-Contrastive-Estimation}
\clearpage
...
\input{Chapters/2-Information-Theory/2-MI}
...
\chapter{Context}
\input{Chapters/3-Representation-Learning/1-Intro}
\clearpage
\chapter{Generative Models}
\input{Chapters/3-Representation-Learning/2-Generative-Models}
\clearpage
\chapter{The InfoNCE Loss}
\input{Chapters/3-Representation-Learning/3-Contrastive-Predictive-Coding}
\clearpage
\chapter{Triplet Losses}
\input{Chapters/3-Representation-Learning/4-Connection-Triplets}
\clearpage
...
\input{Chapters/4-New-Frameworks/1-Introduction}
\chapter{SimCLR}
\input{Chapters/4-New-Frameworks/2-SimCLR}
\chapter{Boostrap Your Own Latent}
\input{Chapters/4-New-Frameworks/3-BYOL}
...
\input{Chapters/5-Experiments/1-Introduction}
\chapter{Experimentation}
\input{Chapters/5-Experiments/2-Experiments}
...
\input{Chapters/APPENDIX/Acknowledgements} 
