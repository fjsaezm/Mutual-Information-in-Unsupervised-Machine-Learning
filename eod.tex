...
\ctparttext{
  \color{black}
  \begin{center}
  Information theory is the base for all the following work. In this part, \emph{Mutual Information} will be explained and then, some cotes for this function will be given.
  \end{center}
}
\part{Information Theory}
\chapter{Mutual Information}
\input{Chapters/info-theory}
