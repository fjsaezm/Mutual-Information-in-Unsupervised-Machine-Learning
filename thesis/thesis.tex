...
\input{Chapters/1-Fundamentals/1-Intro-Objectives}
\clearpage
\chapter{Fundamentals}
\input{Chapters/1-Fundamentals/2-Probability-Theory}
\input{Chapters/1-Fundamentals/2-Distributions}
\clearpage
\section{Statistical Inference}
\input{Chapters/1-Fundamentals/3-Inference}
\section{Introduction to Deep Learning}
\input{Chapters/1-Fundamentals/4-Deep-Learning}
\clearpage
...
\input{Chapters/3-Representation-Learning/1-Noise-Contrastive-Estimation}
\clearpage
 

\chapter{The InfoNCE Loss}
\input{Chapters/3-Representation-Learning/2-Contrastive-Predictive-Coding}
\clearpage
\chapter{Triplet Losses}
\input{Chapters/3-Representation-Learning/3-Connection-Triplets}
\clearpage
...
\chapter{SimCLR}
\input{Chapters/4-New-Frameworks/1-SimCLR}
\chapter{Boostrap Your Own Latent}
\input{Chapters/4-New-Frameworks/2-BYOL}
